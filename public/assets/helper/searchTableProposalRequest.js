...
function getPage(page, perPage, table_n)
{
    ...
    if (table_n == "proposal") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/Proposal-request-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageLogDoc(page, perPage, table_n)
{
    ...
    if (table_n == "proposal-Log") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/Proposal-LogDoc-request-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPagePending(page, perPage, table_n)
{
    ...
    if (table_n == "request") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/request-Pending-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageAwaiting(page, perPage, table_n)
{
    ...
    if (table_n == "proposalAwaiting") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/Proposal-request-Additional-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageLog(page, perPage, table_n)
{
    ...
    if (table_n == "proposal-Log") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/Additional-LogDoc-request-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
