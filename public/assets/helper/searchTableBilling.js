...
function getPageApproved(page, perPage, table_n)
{
    ...
    if (table_n == "proposalApproved") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/billing-Approved-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageReject(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "billingReject") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/billing-reject-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageCancel(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "billingCancel") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/billing-Cancel-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
