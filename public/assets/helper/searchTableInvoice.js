...
function getPageGenerate(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "invoiceGenerate") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/invoice-generate-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageAwaiting(page, perPage, table_n)
{
    ...
    if (table_n == "proposalAwaiting") {
        var table = $('#' + table_name).dataTable({
            ...
            info: false,
            ajax: {
                url: '/invoice-select-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageLog(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "invoiceLog") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/invoice-Log-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageLogDoc(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "invoice-Log") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/invoice-LogDoc-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
...
function getPageCancel(page, perPage, table_n)
{
    ...
    $('#' + table_name).DataTable().destroy();
    if (table_n == "invoiceCancel") {
        var table = $('#' + table_name).dataTable({
            searching: false,
            paging: false,
            info: false,
            ajax: {
                url: '/invoice-Cancel-paginate-table',
                type: 'POST',
                dataType: "json",
                cache: false,
                data: {
