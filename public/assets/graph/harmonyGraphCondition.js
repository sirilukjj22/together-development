function get_graphThisWeek($amount) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-thisWeek/"+date_now+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
...
function get_graphThisMonth($amount) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-thisMonth/"+date_now+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
        success: function(response) {
...
function get_graphThisMonthByDay($amount) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-thisMonthByDay/"+date_now+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
        success: function(response) {
            // Sample data for watch revenue over 7 days
...
function get_graphYearRange($amount, $year) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-yearRange/"+$year+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
        success: function(response) {
            // Sample data for watch revenue over 7 days
...
function get_graphMonthRange($month, $to_month, $year) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-monthRange/"+$month+"/"+$to_month+"/"+$year+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
        success: function(response) {
            // Sample data for watch revenue over 7 days
...
function get_graphDateRang($startDate, $endDate, $amount) {
    ...
    $.ajax({
        type: "GET",
        url: "harmony-sms-graph-daterang/"+$startDate+"/"+$endDate+"/"+type+"/"+account+"",
        datatype: "JSON",
        async: false,
        success: function(response) {
            // Sample data for watch revenue over 30 days
