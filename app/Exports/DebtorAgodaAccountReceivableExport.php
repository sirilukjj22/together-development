...
class DebtorAgodaAccountReceivableExport implements FromView, WithHeadings, ShouldAutoSize, WithStyles
{
    protected $filter_by;
    ...
    public function view(): View
    {
        ...
        return view('pdf.report_agoda.agoda_account_receivable.export_excel', [
