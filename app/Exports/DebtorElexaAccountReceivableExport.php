...
class DebtorElexaAccountReceivableExport implements FromView, WithHeadings, ShouldAutoSize, WithStyles
{
    protected $filter_by;
    ...
    public function view(): View
    {
        ...
        return view('pdf.report_elexa.elexa_revenue.export_excel', [
