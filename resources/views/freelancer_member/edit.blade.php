...
.select2-container {
  ...
  .button-return:hover {
    ...
    <div class="Usertable">
        ...
        <br>
        <form action="{{url('/Freelancer/member/save/update/'.$Freelancer_checked->id)}}" method="POST"enctype="multipart/form-data">
        {!! csrf_field() !!}
            <div>
                ...
                <div class="col-12 row mt-2">
                    ...
                    <div class="col-4" >
                        ...
                        <select name="booking_channel[]" id = "select-3" class="select2" multiple>
                            @php
                ...
                <div class="row">
                    ...
                    <div class="col-4" style="display:flex; justify-content:center; align-items:center;">
                        <button type="button" class="button-return" onclick="window.location.href='{{ route('freelancer_member.view', ['id' => $Freelancer_checked->id]) }}'" >{{ __('ย้อนกลับ') }}</button>
        ...
        <div class="col-12 row mt-3">
            <ul class="nav nav-tabs">
                <li   li class="nav-item">
                    <a class="nav-link" onclick="openHistory(event, 'Summary_Visit_info')" id="defaultOpen">ยอดขายทั้งหมด</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" onclick="openHistory(event, 'Lastest_Visit_info')" >รายได้จากยอดขาย </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " onclick="openHistory(event, 'Billing Folio info')" >ยอดเบิก</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"  onclick="openHistory(event, 'Latest Freelancer By')">ยอดคงเหลือ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " onclick="openHistory(event, 'Lastest Freelancer Commission')" >Commission Points</a>
                </li>
            </ul>
