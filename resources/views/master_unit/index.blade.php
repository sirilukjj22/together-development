        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Unit.</small>
                    <div class=""><span class="span1">Unit (หน่วย)</span></div>
                </div>
                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <caption class="caption-top">
                                <div class="top-table-3c">
                                    ...
                                    <select class="entriespage-button" id="search-per-page-unit" onchange="getPage(1, this.value, 'unit')"> <!-- ชือนำหน้าตาราง, ชื่อ Route -->
                                        <option value="10" class="bg-[#f7fffc] text-[#2C7F7A]" {{ !empty(@$_GET['perPage']) && @$_GET['perPage'] == 10 && @$_GET['table'] == "unit" ? 'selected' : '' }}>10</option>
                                        <option value="25" class="bg-[#f7fffc] text-[#2C7F7A]" {{ !empty(@$_GET['perPage']) && @$_GET['perPage'] == 25 && @$_GET['table'] == "unit" ? 'selected' : '' }}>25</option>
                                        <option value="50" class="bg-[#f7fffc] text-[#2C7F7A]" {{ !empty(@$_GET['perPage']) && @$_GET['perPage'] == 50 && @$_GET['table'] == "unit" ? 'selected' : '' }}>50</option>
                                        <option value="100" class="bg-[#f7fffc] text-[#2C7F7A]" {{ !empty(@$_GET['perPage']) && @$_GET['perPage'] == 100 && @$_GET['table'] == "unit" ? 'selected' : '' }}>100</option>
                                    </select>
                                    <input class="search-button search-data" id="unit" style="text-align:left;" placeholder="Search" />

                                </div>
                            </caption>
                            <div style="min-height: 70vh;" class="mt-2">
                                <table id="unitTable" class="example ui striped table nowrap unstackable hover">
                                    <thead>
                                        <tr>
                            ...
                            <input type="hidden" id="get-total-unit" value="{{ $unit->total() }}">
                            <input type="hidden" id="currentPage-unit" value="1">
                            <caption class="caption-bottom">
                                <div class="md-flex-bt-i-c">
                                    <p class="py2" id="unit-showingEntries">{{ showingEntriesTable($unit, 'unit') }}</p>
                                        <div id="unit-paginate">
                                            {!! paginateTable($unit, 'unit') !!} <!-- ข้อมูล, ชื่อตาราง -->
                                        </div>
                                </div>
                            </caption>
                        </div>
