                            ...
                            <div class="d-grid-2column-banquet">
                                ...
                                <div class="section">
                                    ...
                                    <div>
                                        ...
                                        <hr style="border: 1px solid #000000;" />
                                        <div>
                                            จำนวนทีมงาน : <span id="Number_of_teams">20</span> ท่าน
                                        </div>
                                        <div>
                                            รายละเอียดยานพาหนะ : <span id="Details_of_the_vehicle">รถบัส 2 คัน</span>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="d-grid-2column">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" name="eventDate" id="eventDate" placeholder="DD/MM/YYYY" class="form-control readonly-input" readonly>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="cateringBy" name="catering" placeholder="Enter catering contact"/>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="teamCount" class="form-label">จำนวนทีมงาน</label>
                                                                    <input type="text" class="form-control" id="team" name="team" placeholder="Enter number of team members"/>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="vehicleDetails" class="form-label" >รายละเอียดยานพาหนะ</label>
                                                                    <textarea class="form-control" name="vehicle" id="vehicle" rows="2" placeholder="Enter vehicle details"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div>
                                            <div class="d-grid-2column">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select"  id="RoomSchedule">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="time" class="form-control" id="StartSchedule"   required />
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">End Time</label>
                                                    <input type="time" class="form-control"id="EndSchedule" required />
                                                </div>
                                                <div class="mb-3">
...
<script>
    ...
    function EventDetail() {
        var eventDate = $('#eventDate').val();  // ดึงค่าจาก input ของ eventDate
        var cateringBy = $('#cateringBy').val();  // ดึงค่าจาก input ของ cateringBy
        var teamCount = $('#team').val();  // ดึงค่าจาก input ของ teamCount
        var vehicleDetails = $('#vehicle').val();  // ดึงค่าจาก textarea ของ vehicleDetails
