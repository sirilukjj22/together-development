...
<head>
    ...
    <link rel="stylesheet" href="assets/src/global.css" />
    <style>
        body {
...
<body>
    ...
    <div class="d-flex">
        <section class="sidebar" style="position: relative;">
            ...
            <div class="group-bt">
                ...
                <button type="button" id="add-yellow-box" style="background-color: rgb(248, 215, 70); color: black">
                    Add Box
                </button>
            </div>
            <div class="group-bt">
                <button id="copy-selected">Copy</button>
                <button id="paste-copied">Paste</button>
            </div>
            <div class="group-bt">
        ...
        <div class="room-container" >
            <div id="a4-container">
            <div style="position: absolute;top:1em;" > <img src="image/Logo-tg2.png" alt="" width="70"></div>
            ...
            <div class="px-4 w-100" style="position: absolute;bottom:5px">
                <div class="d-grid mb-2" style="grid-template-columns: 1fr 160px;">
                    <div>
                        <li><strong>Event Time:</strong> <span id="event-time">{{$setup->first_time}}-{{$setup->last_time}} น.</span></li>
                        <li><strong>Place:</strong> <span id="place">{{$setup->room}}</span></li>
                        <li><strong>Set Up:</strong> <span id="setup">{{$setup->details}}</span></li>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body in-modal">
                    <div class="container">
                        ...
                        <ul>
                            <li><Button type="button">Select Room</Button> เลือกห้องที่ต้องการจากรายการ</li>
                            <li><Button type="button">Add Room</Button> เพิ่มห้องใหม่และกำหนดขนาดห้อง พร้อมทั้งกำหนดขนาดเวที ประตูและตำแหน่งที่ประตูอยู่</li>
                            <li><Button type="button">Edit Room</Button> แก้ขนาดห้อง เวที และตำแหน่งประตู</li>
                            <li><Button type="button">Delete Room</Button> ลบห้องที่เลือก</li>
                        </ul>
    ...
    <form id="myForm" action="{{url('/Banquet/Event/Order/save/detail/room/'.$Banquet_ID)}}" method="POST">
        @csrf
        <input type="hidden" id="image-data" name="image_data">
        <input type="hidden" id="image-id" name="image-id" value="{{$Setup_ID}}">
    </form>
</body>
