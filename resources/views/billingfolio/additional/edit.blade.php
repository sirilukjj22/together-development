...
@section('content')
        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <div class="span3">Edit Additional Charge</div>
                </div>
                <div class="col-auto">
    ...
    <form id="myForm" action="{{url('/Document/BillingFolio/Additional/Charge/update/'.$Quotation->id)}}" method="POST">
        @csrf
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                    ...
                                    <div id="Cash_Manualinput" class="col-lg-8 col-md-12 col-sm-12  mt-2 Cash_Manualinput " style="display: none">
                                        <div class="col-lg-12 col-md-12 col-sm-12 row">
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                ...
                                                <input type="text" name="Cash" id="Cash" class="form-control Cash" value="{{$Quotation->Cash}}">
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <label for="">Complimentary</label>
                                                <input type="text" name="Complimentary" id="Complimentary"class="form-control Complimentary" value="{{$Quotation->Complimentary}}">
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-12 mt-3" >
                                                    ...
                                                    <table  class=" example ui striped table nowrap unstackable hover">
                                                        <thead >
                                                            <tr>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <input type="hidden" id="NettotalCheck" name="NettotalCheck" value="{{$Quotation->Nettotal}}">
                                    <div class="styled-hr mt-3"></div>
