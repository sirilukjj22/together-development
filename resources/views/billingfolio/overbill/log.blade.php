        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Log Document Additional.</small>
                    <div class=""><span class="span1"> Log Document Additional (ประวัติการจัดทำเอกสาร)</span></div>
                </div>
            </div> <!-- .row end -->
        </div>
    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade  show active" id="nav-PDF" role="tabpanel" rel="0">
                                    <div style="min-height: 70vh;" class="mt-2">
                                        ...
                                        <table id="proposalLogTable" class="example ui striped table nowrap unstackable hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-priority="1">Additional ID</th>
                                        ...
                                        <input type="hidden" id="profile-proposalLog" name="profile-proposalLog" value="{{$QuotationID}}">
