                                    ...
                                    <div style="min-height: 70vh;" class="mt-2">
                                        <caption class="caption-top">
                                            <div class="flex-end-g2">
                                                ...
                                                <select class="entriespage-button" id="search-per-page-proposalLog" onchange="getPageLogRe(1, this.value, 'proposalLog')"> <!-- ชือนำหน้าตาราง, ชื่อ Route -->
                                        ...
                                        <caption class="caption-bottom">
                                            <div class="md-flex-bt-i-c">
                                                <p class="py2" id="proposalLog-showingEntries">{{ showingEntriesTableLogRe($log, 'proposalLog') }}</p>
                                                <div id="proposalLog-paginate">
                                                    {!! paginateTableLogRe($log, 'proposalLog') !!} <!-- ข้อมูล, ชื่อตาราง -->
                                                </div>
                                            </div>
                                        </caption>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="nav-Log" role="tabpanel" rel="0">
                                    <div style="min-height: 70vh;" class="mt-2">
                                        <caption class="caption-top">
                                            <div class="flex-end-g2">
                                                <label class="entriespage-label">entries per page :</label>
                                                <select class="entriespage-button" id="search-per-page-proposal-Log" onchange="getPageLogDocRe(1, this.value, 'proposal-Log')"> <!-- ชือนำหน้าตาราง, ชื่อ Route -->
                                        ...
                                        <caption class="caption-bottom">
                                            <div class="md-flex-bt-i-c">
                                                <p class="py2" id="proposal-Log-showingEntries">{{ showingEntriesTableLogDocRe($logReceipt, 'proposal-Log') }}</p>
                                                    <div id="proposal-Log-paginate">
                                                        {!! paginateTableLogDocRe($logReceipt, 'proposal-Log') !!} <!-- ข้อมูล, ชื่อตาราง -->
                                                    </div>
                                            </div>
                                        </caption>
                                    </div>
        ...
        $(document).on('keyup', '.search-data-proposalLog', function () {
            ...
            console.log(id);
                ...
                var table = $('#'+table_name).dataTable({
                    ...
                    info: false,
                    ajax: {
                    url: '/billing-Logre-search-table',
                    type: 'POST',
                    dataType: "json",
                    cache: false,
                    data: {
                    ...
                    "initComplete": function (settings,json){
                        ...
                        $('#'+id+'-showingEntries').text(showingEntriesSearchLogRe(1,count_total, id));
                        $('#'+id+'-paginate').append(paginateSearchLogRe(count_total, id, getUrl));
                    },
                    columnDefs: [
        ...
        $(document).on('keyup', '.search-data-proposal-Log', function () {
            ...
            console.log(guest_profile);
                ...
                var table = $('#'+table_name).dataTable({
                    ...
                    info: false,
                    ajax: {
                    url: '/billing-LogDocre-search-table',
                    type: 'POST',
                    dataType: "json",
                    cache: false,
                    data: {
                    ...
                    "initComplete": function (settings,json){
                        ...
                        $('#'+id+'-paginate').children().remove().end();
                        $('#'+id+'-showingEntries').text(showingEntriesSearchLogDocRe(1,count_total, id));
                        $('#'+id+'-paginate').append(paginateSearchLogDocRe(count_total, id, getUrl));
                    },
                    columnDefs: [
