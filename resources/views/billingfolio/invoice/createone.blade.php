                                        ...
                                        <section class="d-grid-2column p-2" >
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="arrival"  placeholder="DD/MM/YYYY" class="form-control" value="{{$Proposal->checkin}}" readonly>
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="departure"  placeholder="DD/MM/YYY" class="form-control" value="{{$Proposal->checkout}}" readonly>
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="border-radius:  0  5px 5px  0 ">
                                                            <i class="fas fa-calendar-alt"></i>
                                                            <!-- ไอคอนปฏิทิน -->
