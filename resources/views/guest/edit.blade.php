                        ...
                        <form action="{{url('/guest/edit/update/'.$Guest->id)}}" method="POST">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control idcard" id="identification_number" name="identification_number"maxlength="17"  value="{{ formatIdCard($Guest->Identification_Number) }}" placeholder="เลขประจำตัวผู้เสียภาษี" >
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-6 col-sm-12 d-flex justify-content-center align-items-center">
                                    <button type="button" class="btn btn-secondary lift  btn-space"  onclick="window.location.href='{{ route('guest','index') }}'">{{ __('Back') }}</button>
