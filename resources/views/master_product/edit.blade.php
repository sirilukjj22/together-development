        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Edit Product Item.</small>
                    <div class=""><span class="span1">Edit Product Item (แก้ไขโปรดักส์)</span></div>
                </div>
            </div> <!-- .row end -->
        </div>
    </div>
                                    ...
                                    <div class="col-12 col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-12">
                                                ...
                                                <input type="text" id="name_th" class="form-control" name="name_th"maxlength="70" value="{{$product->name_th}}">
                                            </div>
                                            <div class="col-lg-6 col-sm-12">
                                                <label for="name_en" >Name_en</label><br>
                                                <input type="text" id="name_en" class="form-control" name="name_en"maxlength="70" value="{{$product->name_en}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-12">
                                                <label for="detail_th">Detail_th</label><br>
                                                <input type="text" id="detail_th" class="form-control" name="detail_th"maxlength="70" value="{{$product->detail_th}}">
                                            </div>
                                            <div class="col-lg-6 col-sm-12">
                                                <label for="detail_en">Detail_en</label><br>
                                                <input type="text" id="detail_en" class="form-control" name="detail_en"maxlength="70" value="{{$product->detail_en}}">
                                            </div>
                                        </div>
                                        <div class=" row">
                                            <div class="col-lg-6 col-sm-12" ><label for="pax">Pax</label><br>
                                                <input type="text" id="pax" class="form-control" name="pax"maxlength="70"  value="{{$product->pax}}">
                                            </div>
                                            <div class="col-lg-6 col-sm-12" ><label for="room_size">Room size (Sqm.)</label><br>
                                                <input type="text" id="room_size" class="price-input form-control" name="room_size"maxlength="70"value="{{$product->room_size}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-4 col-sm-12" id="normal_price_container" style="display: block;">
                                                ...
                                                <input type="text" class="price-input form-control" id="normal_price" name="normal_price" maxlength="70" value="{{$product->normal_price}}">
                                            </div>
                                            <div class="col-lg-4 col-sm-12" ><label for="Maximum_Discount">Maximum Discount</label><br>
                                                <input type="text" id="Maximum_Discount" class="form-control" name="Maximum_Discount"maxlength="70" required value="{{$product->maximum_discount}}">
                                            </div>
                                            <div class="col-lg-4 col-sm-12" ><label for="Maximum_Discount">Number of rooms</label><br>
                                                <input type="text" id="room" class="form-control" name="room"maxlength="70" value="{{$product->NumberRoom}}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-12" >
