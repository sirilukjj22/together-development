        ...
        @if ($viewComMassage->status == 1)
            <div class="col-12 d-flex justify-content-center">
                <div class="button-guest-end">
                    <button type="button" class="btn" onclick="window.location.href='{{ route('freelancer.boss.examine') }}'">{{ __('ย้อนกลับ') }}</button>
                </div>
            </div>
        ...
        @else
            <div class="col-12 row">
                ...
                <div class="col-4 button-guest">
                    <button type="button" class="btn" onclick="window.location.href='{{ route('freelancer.boss.examine.status', $datamassage) }}'">
                        {{ __('อนุมัติ') }}
                    </button>
                </div>
            </div>
