                ...
                <div class="card p-4 mb-4">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-lg-5 col-md-4 col-sm-12">
                            ...
                            <input type="text"class="form-control" placeholder="First Name" id="first_name" name="first_name" maxlength="70"  value="{{$Freelancer_checked->First_name}}" required>
                        </div>
                        <div class="col-lg-5 col-md-4 col-sm-12"><label for="last_name">นามสกุล / Last Name</label><br>
                            <input type="text" class="form-control" placeholder="Last Name" id="last_name" name="last_name" maxlength="70" value="{{$Freelancer_checked->Last_name}}" required>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-12 col-md-12 col-sm-12" >
                            ...
                            <textarea type="text" id="address" name="address" rows="3" cols="35" class="form-control" aria-label="With textarea" required>{{$Freelancer_checked->Address}}</textarea>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-lg-4 col-md-4 col-sm-12" >
                            <label for="email">อีเมล / Email</label><br>
                            <input type="text" class="form-control" id="email" name="email"maxlength="70" value="{{$Freelancer_checked->Email}}" required>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12" >
                            <label for="Birthday">วันเดือนปีเกิด / Birthday</label><br>
                            <input type="date" class="form-control" id="Birthday" name="Birthday" value="{{$Freelancer_checked->Birthday}}" required>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12" >
                            <label for="First_day_work">วันที่เริ่มทำงาน / First day of work</label><br>
                            <input type="date" class="form-control" id="First_day_work" name="First_day_work" value="{{$Freelancer_checked->First_day_work}}" required>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-6 col-md-6 col-sm-12" >
                            ...
                            <input type="text" class="form-control" id="identification_number" name="identification_number"maxlength="13" value="{{$Freelancer_checked->Identification_number}}" required>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <label for="Identification_Number_file">เอกสารหมายเลขประจำตัว / Identification File </label><br>
                            <input type="file" id="Identification_Number_file" class="form-control" name="Identification_Number_file" accept="image/jpeg, image/png, image/svg" >
                        </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="Bank_number" name="Bank_number"maxlength="10" class="form-control" value="{{$Freelancer_checked->Bank_number}}" required>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <label for="Account_Name">Bank Account Name</label><br>
                            <input type="text" id="Account_Name" name="Account_Name"maxlength="70" class="form-control" value="{{$Freelancer_checked->Bank_account_Name}}" required>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div class="col-lg-2 col-md-5 col-sm-12">
                            ...
                            <input type="file" id="Bank_file" name="Bank_file" class="form-control" accept="image/jpeg, image/png, image/svg"   >
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-12 mt-2 ">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-6 col-sm-12 d-flex justify-content-center align-items-center">
                            <button type="button" class="btn btn-secondary lift  btn-space"  onclick="window.location.href='{{ route('freelancer.index') }}'">{{ __('ย้อนกลับ') }}</button>
