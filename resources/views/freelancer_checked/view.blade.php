...
<div class="container">
    ...
    <div class="col-12 row">
        ...
        <div class="col-lg-2 col-md-6 col-sm-12"><label for="Preface">Title</label><br>
            <select name="Preface" id="PrefaceSelect" class="select" disabled>
                <option value=""></option>
        ...
        <input type="text" id="first_name" name="first_name"maxlength="70" value="{{$Freelancer_checked->First_name}}" disabled></div>
        <div class="col-lg-3 col-md-6 col-sm-12" ><label for="last_name" >Last Name</label><br>
        <input type="text" id="last_name" name="last_name"maxlength="70" value="{{$Freelancer_checked->Last_name}}" disabled></div>
    </div>
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" id="cityInput" style="display:none;" disabled>
        ...
        @else
            <div class="col-lg-4 col-md-6 col-sm-12" id="citythai" style="display:none;" disabled>
                <label for="city">City</label><br>
    ...
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12" >
            ...
            <textarea type="text" id="address" name="address" rows="5" cols="35" class="textarea" aria-label="With textarea" disabled>{{$Freelancer_checked->Address}}</textarea>
        </div>
    </div>
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12" >
            ...
            <input type="text" id="email" name="email"maxlength="70" disabled value="{{$Freelancer_checked->Email}}">
        </div>
    </div>
    <div class="col-12 row mt-2">
        <div class="col-lg-2 col-md-2 col-sm-12"></div>
        <div class="col-lg-4 col-md-4 col-sm-12" >
            ...
            <input type="date" id="Birthday" name="Birthday" disabled  value="{{$Freelancer_checked->Birthday}}">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12" >
            <label for="First_day_work">First day of work</label><br>
            <input type="date" id="First_day_work" name="First_day_work" disabled  value="{{$Freelancer_checked->First_day_work}}">
        </div>
    </div>
    <div class="col-12 row mt-2">
        <div class="col-lg-2 col-md-2 col-sm-12"></div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <div id="phone-container" class="flex-container row">
                ...
                <div class="col-lg-12 col-md-6 col-sm-12 phone-group show" >
                    ...
                    disabled value="{{ $phone['Phone_number'] }}">
                </div>
                @endforeach
            </div>
        </div>
    ...
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12" >
            ...
            <input type="text" id="identification_number" name="identification_number"maxlength="13" disabled value="{{$Freelancer_checked->Identification_number}}">
        </div>
    ...
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
            ...
            <input type="text" id="Bank_number" name="Bank_number"maxlength="10" disabled value="{{$Freelancer_checked->Bank_number}}">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 mt-2" >
            <label for="Account_Name">Bank Account Name</label><br>
            <input type="text" id="Account_Name" name="Account_Name"maxlength="70" disabled value="{{$Freelancer_checked->Bank_account_Name}}">
        </div>
    </div>
    <div class="col-12 row mt-2">
        <div class="col-lg-2 col-md-2 col-sm-12"></div>
    ...
    <div class="col-12 row mt-2">
        ...
        <div class="col-lg-4 col-md-2 col-sm-12 ">
            <div class="row">
                <div class="col-lg-12 col-md-2 col-sm-12 mt-2" >
