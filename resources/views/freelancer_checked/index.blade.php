...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <div class="Usertable">
        ...
        {{-- <button class="statusbtn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          {{-- <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="{{ route('freelancer.index') }}">ทั้งหมด</a>
            <a class="dropdown-item" style="color: green;" href="{{ route('freelancer.ac', ['value' => 1]) }}">เปิดใช้งาน</a>
            <a class="dropdown-item" style="color: #f44336;" href="{{ route('freelancer.no', ['value' => 0]) }}">ปิดใช้งาน</a>
          </div> --}}
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="licolor"><a href="{{ url('/Freelancer/check/edit/'.$item->id) }}">แก้ไขข้อมูล</a></li>
                                            <li class="licolor"><a href="{{ url('/Freelancer/check/view/'.$item->id) }}">ดูข้อมูล</a></li>
    ...
    function confirmDeletecheck(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('/Freelancer/member/AgentM/delete/') }}",
                    type: 'POST',
                    data: { ids: Guestid },
                    async: false,
    ...
    $('.status-toggle').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('freelancer.changeStatus') }}",
            data: {
