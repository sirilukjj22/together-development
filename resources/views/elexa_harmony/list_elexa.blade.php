...
<div id="content-index" class="body-header border-bottom d-flex py-3">
    <div class="container-xl">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="{{ route('harmony-debit-elexa') }}" class="bt-tg-normal">Back</a>
            </div>
        </div> <!-- .row end -->
    </div>
</div>
            ...
            <table id="elexaRevenueDayTable" class="table-together table-style">
                <thead>
                    <tr>
                        ...
                        <th data-priority="3">Lock/Unlock</th>
                ...
                <tbody>
                    @foreach ($elexa_revenue as $key => $item)
                        ...
                        <tr>
                            ...
                            <td class="">
                                <div class="">
                                    <img class="img-bank" src="../image/bank/SCB.jpg" style="border-radius: 50%;"> {{ 'SCB ' . $item->into_account }}
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="dropdown center">
                                    ...
                                    <ul class="dropdown-menu btn-dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($item->status_receive_elexa == 0)
                                            <li>
                                                <a href="{{ route('harmony-debit-elexa-update-receive', [$item->id, $month, $year]) }}" class="dropdown-item">Create</a>
                                            </li>
                                        @else
                                            @php
                                            ...
                                            @if (@$item->statusLockElexa->status_lock == 0)
                                                <li>
                                                    <a href="{{ route('harmony-debit-elexa-update-receive', [$item->id]) }}" class="dropdown-item">Edit</a>
                                                </li>
                                            @endif
                                        @endif
                                        <li>
                                            <a href="{{ route('harmony-debit-elexa-detail', [$item->id]) }}" class="dropdown-item">View</a>
                                        </li>
                                        @if ($item->status_receive_elexa == 1)
                                            <li>
                                                <a href="{{ route('harmony-debtor-elexa-logs', $item->id) }}" class="dropdown-item">Log</a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
