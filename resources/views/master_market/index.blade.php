    ...
    <div class="container-fluid border rounded-3 p-5 mt-3 bg-white" style="width: 98%;">
        ...
        <div class="col-lg-12" style="float: right">
            <div  class="col-lg-4" style="float: right">
                <button type="button" class="create"  data-bs-toggle="modal" data-bs-target="#MarketCreate">
                    + Add Market
                </button>
            </div>
        </div>
                                ...
                                <td>
                                    <div class="dropdown-a">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="licolor"><a  data-bs-toggle="modal" data-bs-target="#editmerket{{$item->id}}">แก้ไขข้อมูล</a></li>
        ...
        @foreach ($Mmarket as $item)
            <div class="modal fade" id="editmerket{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header"style=" background-color: #2D7F7B;">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">Edit Market</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ url('/Mmarket/master_Mmarket/Mmarket_update/') }}" method="POST"enctype="multipart/form-data">
                            @csrf
                            <div class="col-12 ">
        ...
        @endforeach
        <div class="modal fade" id="MarketCreate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header"style=" background-color: #2D7F7B;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">+ Add Market</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{route('Mmarket.save')}}" method="POST"enctype="multipart/form-data">
                        @csrf
                        <div class="col-12 ">
                            <div class="col-12">
                                <label for="code">Code</label>
