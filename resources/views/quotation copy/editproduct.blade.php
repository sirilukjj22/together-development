...
@section('pretitle')
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <small class="text-muted">Welcome to Edit Product to Proposal.</small>
                <h1 class="h4 mt-1">Edit Product to Proposal (แก้ไขโปรดักส์ลงข้อเสนอ)</h1>
            </div>
        </div>
    </div>
@endsection
    ...
    function BACKtoEdit(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('Quotation.edit', ['id' => $Quotation->id]) }}";
            }
        });
    }
</script>
