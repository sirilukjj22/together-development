                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <span class="titleQuotation">{{$Quotation->Quotation_ID}}</span>
                                    ...
                                    <div id="reportrange1" style="background: #fff; cursor: pointer; padding: 5px 10px; width: 100%;" >
                                        <div class="col-12 col-md-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <input type="text" id="datestart" class="form-control" name="IssueDate" style="text-align: left;"readonly value="{{$Quotation->issue_date}}">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select name="Company" id="Company" class="select2" onchange="companyContact()" required>
                                    @foreach($Company as $item)
                                        <option value="{{ $item->Profile_ID }}{{$Quotation->Company_ID == $item->id}}">{{ $item->Company_Name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="form-control form-daterangepicker" id="reportrange">
                                    ...
                                    <input type="hidden" name="Checkin" id="Checkin"value="{{$Quotation->checkin}}">
                                    <input type="hidden" name="Checkout"id="Checkout"value="{{$Quotation->checkout}}">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="">จำนวน</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="Day" placeholder="จำนวนวัน"value="{{$Quotation->day}}">
                                    <span class="input-group-text">Day</span>
                                    <input type="text" class="form-control" name="Night" placeholder="จำนวนคืน" value="{{$Quotation->night}}">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="Adult"  placeholder="จำนวนผู้ใหญ่"value="{{$Quotation->adult}}" >
                                    <span class="input-group-text">ผู้ใหญ่</span>
                                    <input type="text" class="form-control" name="Children" placeholder="จำนวนเด็ก" value="{{$Quotation->children}}">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="Max_discount" placeholder="ส่วนลดคิดเป็น %" value="{{$Quotation->maxdiscount}}" aria-describedby="basic-addon2">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control " name="place" aria-label="Amount (to the nearest dollar)" required value="{{$Quotation->place}}">
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                ...
                                <select name="Mvat" id="Mvat" class="select2" required>
                                    @foreach($Mvat as $item)
                                        <option value="{{ $item->id }}"{{$Quotation->Mvat == $item->id ? 'selected' : ''}}>{{ $item->name_th }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-12 col-md-6 col-sm-12 row mt-3">
                                <div class="col-4"></div>
                                <div class="col-4 "  style="display:flex; justify-content:center; align-items:center;">
                                    ...
                                    <button type="submit" class="btn btn-color-green lift btn_modal">NEXT</button>
                                </div>
                                <div class="col-4"></div>
                            </div>
                        </div>
