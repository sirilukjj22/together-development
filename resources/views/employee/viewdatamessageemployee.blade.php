...
<div class="Usertable">
    <div class="usertopic">
        <div class="row">
            ...
            <div class="col-6"></div>
            <div class="col-2" >
                @if ($viewComMassage->status == 1)
                <label style="color: #35a915;text-align: right; display: block;">อนุมัติแล้ว</label>
                @elseif ($viewComMassage->status == 2)
    ...
    <table class="table">
        ...
        @if ($viewComMassage->status == 1)
            <div class="col-12 row">
                <div class="col-2"></div>
                <div class="col-4 button-guest-end">
                    <button type="button" class="btn" onclick="window.location.href='{{ route('freelancer.employee.examine') }}'">{{ __('ย้อนกลับ') }}</button>
                </div>
                <div class="col-4 button-guest">
                    <button type="button" class="btn" onclick="window.location.href='{{ route('freelancer.employee.examine.status', $datamassage) }}'">
                        {{ __('อนุมัติ') }}
                    </button>
                </div>
            </div>
