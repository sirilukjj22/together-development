...
<div class="Usertablecontainer">
    <div class="row">
        <div class="titleh1 col-lg-6 col-md-6 col-sm-6">
            <h1>Data Massage to Employee</h1>
        </div>
    </div>
    <div>
            ...
            <tbody>
                @if (!empty($Company_massage))
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="image-read-button" onclick="window.location.href = '{{ url('/Freelancer/employee/view/data/'.$item->id) }}'"></button>
                        </td>
