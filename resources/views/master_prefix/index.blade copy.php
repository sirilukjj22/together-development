...
<style>
    ...
    <div class="container-fluid border rounded-3 p-5 mt-3 bg-white" style="width: 98%;">
        ...
        <div class="col-lg-12" style="float: right">
            <div  class="col-lg-4" style="float: right">
                <button type="button" class="create"  data-bs-toggle="modal" data-bs-target="#PrefixCreate">
                    + Add Prefix
                </button>
            </div>
        </div>
        <div  class="col-4 mt-3 statusbtndiv">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{ route('Mprefix.index') }}">ทั้งหมด</a>
                <a class="dropdown-item" style="color: green;" href="{{ route('Mprefix.ac', ['value' => 1]) }}">เปิดใช้งาน</a>
                <a class="dropdown-item" style="color: #f44336;" href="{{ route('Mprefix.no', ['value' => 0]) }}">ปิดใช้งาน</a>
            </div>
        </div>
                                ...
                                <td>
                                    <div class="dropdown-a">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="licolor"><a  data-bs-toggle="modal" data-bs-target="#editprefix{{$item->id}}">แก้ไขข้อมูล</a></li>
                                        </ul>
                                </td>
                            </tr>
                        @endforeach
    ...
    @foreach ($M_prefix as $item)
    <div class="modal fade" id="editprefix{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header"style=" background-color: #2D7F7B;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">Edit Prefix</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
              </div>
            <div class="modal-body">
                <form action="{{ url('/Mprefix/master_prefix/Mprefix_update/') }}" method="POST"enctype="multipart/form-data">
                    @csrf
    ...
    @endforeach
    <div class="modal fade" id="PrefixCreate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header"style=" background-color: #2D7F7B;">
              <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">+ Add Prefix</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('Mprefix.save')}}" method="POST"enctype="multipart/form-data">
                    @csrf
                    <div class="col-12 row">
                        <div class="col-6">
                            <label for="Name_th">Name th</label><br>
