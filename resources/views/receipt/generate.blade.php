                                    ...
                                    @if ($vat_type == 50 )
                                        <table class="table table-borderless" id="PRICE_INCLUDE_VAT" >
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td scope="row" style="text-align:right;width: 55%;font-size: 14px;"><b>Subtotal less Deposit</b></td>
                                            ...
                                            <tr>
                                                <td style="text-align:center;">
                                                    <div style="display: flex; justify-content: center; align-items: center; border: 2px solid #2D7F7B; background-color: #2D7F7B; border-radius: 5px; color: #ffffff;padding:5px;  padding-bottom: 8px;">
                                                        ...
                                                        <strong id="total-Price" style="font-size: 16px; margin-left: 10px;"><span id="Net-Total">{{ number_format($Nettotal-$totalinvoice, 2, '.', ',') }} </span></strong><input type="hidden" id="Nettotal" name="Nettotal" value="{{$Nettotal-$totalinvoice}}">
