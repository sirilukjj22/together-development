...
@section('pretitle')
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <small class="text-muted">Welcome to Generate Receipt.</small>
                <h1 class="h4 mt-1">Generate Receipt (สร้างใบเสร็จ)</h1>
            </div>
        </div>
    </div>
@endsection
@section('content')
<form id="myForm" action="{{route('receipt.save')}}" method="POST">
    @csrf
        <div class="container">
                        ...
                        <div class="card p-4 mb-4">
                            ...
                            <div class="row mt-2">
                                ...
                                <table class="table table-borderless" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>ใบที่ {{$key +1}} </td>
                                            <td>ใบเสร็จชำระเงิน อ้างอิงจาก Receip ID : {{$item->receipt_ID}} <input type="hidden" id="receipt" name="receipt" value="{{$item->receipt_ID}}"></td>
                                            <td>
                                            </td>
                                            ...
                                            <tr>
                                                <td style="text-align:center;">
                                                    <div style="display: flex; justify-content: center; align-items: center; border: 2px solid #2D7F7B; background-color: #2D7F7B; border-radius: 5px; color: #ffffff;padding:5px;  padding-bottom: 8px;">
                                                        ...
                                                        <strong id="total-Price" style="font-size: 16px; margin-left: 10px;"><span id="Net-Total">{{ number_format($Nettotal, 2, '.', ',') }} </span></strong>
                                                        <input type="hidden" id="Nettotal" name="Nettotal" value="{{$Nettotal}}">
                            ...
                            <div class="col-12 row mt-5">
                                ...
                                <div class="col-4 "  style="display:flex; justify-content:center; align-items:center;">
                                    ...
                                    @if ($status == 1 )
                                        <button type="submit" class="btn btn-primary lift btn_modal btn-space" >
                                            Save
                                        </button>
                                    @else
                                        <button type="submit" class="btn btn-primary lift btn_modal btn-space" disabled>
                                            Save
                                        </button>
                                    @endif
                                </div>
