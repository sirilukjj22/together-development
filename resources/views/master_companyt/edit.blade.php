...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <div class="Usertable">
        ...
        <br>
        <form action="{{url('/Mcomt/master_comt/Mcomt_update/'.$M_Company_type->id)}}" method="POST">
        {!! csrf_field() !!}
            <div>
                <div class="col-12 row">
                    ...
                    <div class="col-4" >
                        ...
                        <input type="text" id="name_th" name="name_th"maxlength="70" required value="{{$M_Company_type->name_th}}">
                    </div>
                    <div class="col-4" >
                        <label for="name_en">Name_en</label><br>
                        <input type="text" id="name_en" name="name_en"maxlength="70" required value="{{$M_Company_type->name_en}}">
                    </div>
                </div>
