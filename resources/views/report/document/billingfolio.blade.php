                ...
                <div class="row clearfix mb-3">
                    <div class="col-12 d-flex flex-column flex-md-row justify-content-between">
                        ...
                        <div class="form-container mb-3 mb-md-0">
                            <form action="{{ route('report-billingfolio-search') }}" method="POST" enctype="multipart/form-data" id="form-search" class="row g-3">
                                @csrf
                                <div class="col-md-12">
                                    <h3>Search</h3>
                                </div>
                                ...
                                <div class="col-md-12 d-flex flex-row gap-3 mt-4 d-al-center">
                                    <div class="form-check">
                                        <input class="form-check-input " type="radio" name="statusinput" id="statusApproved" value="1" {{ isset($status) && $status == '1' ? 'checked' : '' }}>
                                        <label class="btn btn-success " for="statusApproved" style="pointer-events: none;">Confirm</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input " type="radio" name="statusinput" id="statusComplete" value="2" {{ isset($status) && $status == '2' ? 'checked' : ''}}>
                ...
                <div id="content-to-export" class="table-2" style="overflow-x:auto;padding: 1em;">
                    <div class="d-flex gap-3 m-3">
                        ...
                        <div class="text-capitalize d-grid gap-0" style="height: max-content;">
                            ...
                            <span>Document Billing Folio</span>
                            ...
                            <table id="ProposalTable" class="table-together table-style" >
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;" data-priority="1">Receipt ID</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-content-center">{{ $item->Receipt_ID}}</td>
                                        ...
                                        <td class="td-content-center">{{ number_format($item->document_amount) }}</td>
