        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <div class="span3">Elexa EGAT Outstanding Report</div>
                </div>
                <div class="col-auto">
            ...
            <div class="row clearfix mb-3">
                <div class="col-12 d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <div class="form-container mb-3 mb-md-0">
                        <form action="{{ route('report-elexa-outstanding-search') }}" method="POST" enctype="multipart/form-data" id="form-search" class="row g-3">
                            @csrf
                            <div class="col-md-12">
                                <h3>Search</h3>
                            </div>
            ...
            <div id="content-to-export" class="table-2" style="overflow-x:auto;padding: 1em;">
                <div class="d-flex gap-3 m-3">
                    ...
                    <div class="text-capitalize d-grid gap-0" style="height: max-content;">
                        ...
                        <span>Elexa EGAT Outstanding</span>
