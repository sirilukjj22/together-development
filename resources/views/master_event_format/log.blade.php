        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Event Format Log.</small>
                    <div class=""><span class="span1">Event Format Log</span></div>
                </div>
            </div> <!-- .row end -->
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 row mt-5">
                                ...
                                <div class="col-4 "  style="display:flex; justify-content:center; align-items:center;">
                                    <button type="button" class="btn btn-secondary lift btn_modal btn-space" onclick="window.location.href='{{ route('MEvent','index') }}'">
                                        Back
                                    </button>
                                </div>
                                <div class="col-4"></div>
