...
<style>
    ...
    <div class="Usertable">
        ...
        <div>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{ route('MEvent.index') }}">ทั้งหมด</a>
                <a class="dropdown-item" style="color: green;" href="{{ route('MEvent.ac', ['value' => 1]) }}">เปิดใช้งาน</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="licolor"><a  data-bs-toggle="modal" data-bs-target="#editevent{{$item->id}}">แก้ไขข้อมูล</a></li>
                                        </ul>
                                </td>
                            </tr>
                        @endforeach
    ...
    <div class="modal fade" id="editevent{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header"style=" background-color: #2D7F7B;">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">Edit Event Format</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ url('/MEvent/Event_Formate/update') }}" method="POST"enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" id="detail_th" name="detail_th"maxlength="70" value="{{$item->detail_th}}">
                                </div>
                                <div class="col-6">
                                    <label for="Detail_en">Detail en </label><br>
                                    <input type="text" id="detail_en" name="detail_en"maxlength="70" value="{{$item->detail_en}}">
                                </div>
                            </div>
                        </div>
    ...
    {{-- modal create --}}
    <div class="modal fade" id="EventCreate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header"style=" background-color: #2D7F7B;">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel" style=" color: #FFFFFF;">+ Add Event Format</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" style=" background-color: #FFFFFF;" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{route('MEvent.save')}}" method="POST"enctype="multipart/form-data">
                        @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'GET',
            url: "{{ url('/MEvent/changeStatus_Event/') }}" + '/' + id + '/' + status,
