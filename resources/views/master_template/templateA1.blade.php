...
@section('content')
        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    ...
                    <div class=""><span class="span1">Template A1 (แบบฟอร์ม A1)</span></div>
                </div>
                <div class="col-auto">
                </div>
            </div> <!-- .row end -->
    ...
    <script>
        function editTemplate() {
            ...
            var isShowHidden = showDiv.style.display === 'none';

            showDiv.style.display = isShowHidden ? 'block' : 'none';
            editDiv.style.display = isShowHidden ? 'none' : 'block';
        }
