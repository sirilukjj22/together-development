...
@section('content')
        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Vat Log.</small>
                    <div class=""><span class="span1">Vat Log</span></div>
                </div>
            </div> <!-- .row end -->
        </div>
    </div>
    ...
    <script type="text/javascript" src="{{ asset('assets/helper/searchTableMasterSystem.js')}}"></script>
