                ...
                <div class="col-md-12 col-12">
                    <div class="card p-4 mb-4">
                        <div style="min-height: 70vh;">
                            <table id="revenueCashTable" class="table-together table-style">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($data_query as $key => $item)
                                        <tr style="text-align: center;">
                                            ...
                                            <td style="text-align: left;" class="target-class text-end">{{ $item->amount }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="2" class="fw-bold" style="background-color: #dff8f0;">Total</td>
