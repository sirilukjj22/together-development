                ...
                <div class="col-md-12 col-12">
                    <div class="card p-4 mb-4">
                        <div style="min-height: 70vh;">
                            <table id="manualElexaTable" class="table-together table-style">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($data_query as $key => $item)
                                        <tr style="text-align: center;">
                                            ...
                                            <td class="td-content-center target-class text-end">{{ $item->ev_charge }}</td>
                                            <td class="td-content-center target-class text-end">{{ $item->ev_fee }}</td>
                                            <td class="td-content-center target-class text-end">{{ $item->ev_vat }}</td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="7" class="fw-bold" style="background-color: #dff8f0;">Total</td>
                                        <td class="fw-bold text-end" style="background-color: #dff8f0;">{{ number_format($total_query, 2) }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
