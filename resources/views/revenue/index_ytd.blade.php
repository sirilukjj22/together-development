...
@section('content')
    ...
    <div class="container-fluid pt-3 pb-3 mb-3 mt-3 rounded bg-light" style="width: 98%;">
        ...
        <?php 
            ...
            $total_year_revenue_graph = $total_cash_bank_year + $total_wp_cash_bank_year + $total_agoda_year + $total_ev_year + ($credit_revenue_year->total_credit ?? 0) + ($total_wp_year->wp_credit ?? 0);
        ?>
        ...
        <div class="row g-2">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="title-box">
                    ...
                    <h1>{{ number_format(($agoda_charge[0]['total_year'] - $total_agoda_year) + $ev_charge[0]['total_year'], 2) }}</h1>
                </div>
                <div class="d-flex align-content-stretch flex-wrap trorevenue">
                    <a href="#" class="list-box6 list-box-color">
                        ...
                        <h3>{{ number_format($agoda_charge[0]['total_year'] - $total_agoda_year, 2) }}</h3>
                    </a>

                    <a href="#" class="list-box6 list-box-color">
                        <img src="../assets2/images/elexa.png" alt="">
                        <h2>Elaxa EGAT Revenue Outstanding</h2>
                        <h3>{{ number_format($ev_charge[0]['total_year'], 2) }}</h3>
                    </a>
