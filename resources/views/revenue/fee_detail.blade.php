                                ...
                                <tbody>
                                    ...
                                    @foreach ($data_query as $key => $item)
                                        ...
                                        if ($status == "credit_hotel_fee") {
                                            $sum_charge = App\Models\Revenue_credit::where('revenue_id', $item->id)->sum('credit_amount');
                                        } else {
                                            $sum_charge = App\Models\Revenue_credit::where('revenue_id', $item->id)->sum('ev_fee');
                                        }
                                        @endphp
