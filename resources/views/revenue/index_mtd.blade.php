    ...
    <div class="container-fluid pt-3 pb-3 mb-3 mt-3 rounded bg-light" style="width: 98%;">
        ...
        <div class="row mt-1 g-2">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="title-box">
                    <h2>Cash</h2>
                    <h1>{{ number_format($total_cash_month + $total_wp_month->wp_cash, 2) }}</h1>
                    <input type="hidden" id="total_cash_dashboard" value="{{ $total_cash_month + $total_wp_month->wp_cash }}">
                </div>
                ...
                <div class="d-flex align-content-stratch flex-wrap cash"
                    ...
                    <a href="#" class="list-box list-box-color">
                        ...
                        <h2>Front Desk</h2>
                        <h3>{{ number_format(isset($total_front_month) ? $total_front_month->front_cash : 0, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box list-box-color">
                        <img src="../assets2/../assets2/images/guest.png" alt="">
                        <h2>Guest Deposit</h2>
                        <h3>{{ number_format(isset($total_guest_deposit_month) ? $total_guest_deposit_month->room_cash : 0, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box list-box-color">
                        <img src="../assets2/../assets2/images/F&B.png" alt="">
                        <h2>All Outlet </h2>
                        <h3>{{ number_format($total_fb_month->fb_cash, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box list-box-color">
                        <img src="../assets2/../assets2/images/water-park.png" alt="">
                        <h2>Water Park</h2>
                        <h3>{{ number_format($total_wp_month->wp_cash, 2) }}</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 ">
                ...
                <div class="title-box">
                    <h2>Bank Transfer</h2>
                    <h1>{{ number_format($total_bank_transfer_month + $total_wp_month->wp_transfer + ($total_agoda_month + $total_ev_month), 2) }}</h1>
                    <input type="hidden" id="total_bank_dashboard" value="{{ ($total_bank_transfer_month + $total_wp_month->wp_transfer) + ($total_agoda_month + $total_ev_month) }}">
                </div>
                <div class="d-flex align-content-stretch flex-wrap bank"
                    ...
                    <a href="#" class="list-box3 list-box-color">
                        ...
                        <h2>Front Desk</h2>
                        <h3>{{ number_format(isset($total_front_month) ? $total_front_month->front_transfer : 0, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box3 list-box-color">
                        <img src="../assets2/images/guest.png" alt="">
                        <h2>Guest Deposit</h2>
                        <h3>{{ number_format(isset($total_guest_deposit_month) ? $total_guest_deposit_month->room_transfer : 0, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box3 list-box-color">
                        <img src="../assets2/images/F&B.png" alt="">
                        <h2>All Outlet</h2>
                        <h3>{{ number_format($total_fb_month->fb_transfer, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box3 list-box-color">
                        <img src="../assets2/images/water-park.png" alt="">
                        <h2>Water Park</h2>
                        <h3>{{ number_format($total_wp_month->wp_transfer, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box3 list-box-color">
                        <img src="../assets2/images/agoda.png" alt="">
                        <h2>Agoda</h2>
                        <h3>{{ number_format($total_agoda_month, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box3 list-box-color">
                        <img src="../assets2/images/elexa.png" alt="">
                        <h2>Elexa EGAT</h2>
                        <h3>{{ number_format($total_ev_month, 2) }}</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="title-box">
                    <h2>Credit Card</h2>
                    <h1>{{ number_format(($credit_revenue_month->total_credit ?? 0) + ($total_wp_month->wp_credit ?? 0), 2) }}</h1>
                    <input type="hidden" id="total_credit_dashboard" value="{{ ($credit_revenue_month->total_credit ?? 0) + ($total_wp_month->wp_credit ?? 0) }}">
                </div>
                ...
                <div class="d-flex align-content-stretch flex-wrap creditrevenue">
                    <a href="#" class="list-box2 list-box-color">
                        ...
                        <h2>Hotel</h2>
                        <h3>{{ number_format($credit_revenue_month->total_credit ?? 0, 2) }}</h3>
                    </a>

                    <a href="#" class="list-box2 list-box-color">
                        <img src="../assets2/images/water-park.png" alt="">
                        <h2>Water park</h2>
                        <h3>{{ number_format($total_wp_month->wp_credit ?? 0, 2) }}</h3>
                    </a>
        ...
        <div class="row g-2">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="title-box">
                    <h2>Manual Charge</h2>
                    <h1>{{ number_format(($sum_charge_month + $wp_charge[0]['total_month']) + ($agoda_charge[0]['revenue_credit_month'] + $ev_charge[0]['revenue_credit_month']), 2) }}</h1>
                </div>
                <div class="d-flex align-content-stretch flex-wrap manual"
                    ...
                    <a href="#" class="list-box4 list-box-color">
                        ...
                        <h3>{{ number_format($front_charge[0]['revenue_credit_month'], 2) }}</h3>
                    </a>

                    <a href="#" class="list-box4 list-box-color">
                        <img src="../assets2/images/guest.png" alt="">
                        <h2>Credit Card Guest Deposit</h2>
                        <h3>{{ number_format($guest_deposit_charge[0]['revenue_credit_month'], 2) }}</h3>
                    </a>

                    <a href="#" class="list-box4 list-box-color">
                        <img src="../assets2/images/F&B.png" alt="">
                        <h2>Credit Card All Outlet</h2>
                        <h3>{{ number_format($fb_charge[0]['revenue_credit_month'], 2) }}</h3>
                    </a>

                    <a href="#" class="list-box4 list-box-color">
                        <img src="../assets2/images/water-park.png" alt="">
                        <h2>Credit Card Water Park</h2>
                        <h3>{{ number_format($wp_charge[0]['total_month'], 2) }}</h3>
                    </a>

                    <a href="#" class="list-box4 list-box-color">
                        <img src="../assets2/images/agoda.png" alt="">
                        <h2>Agoda</h2>
                        <h3>{{ number_format($agoda_charge[0]['revenue_credit_month'], 2) }}</h3>
                    </a>

                    <a href="#" class="list-box4 list-box-color">
                        <img src="../assets2/images/elexa.png" alt="">
                        <h2>Elaxa EGAT</h2>
                        <h3>{{ number_format($ev_charge[0]['revenue_credit_month'], 2) }}</h3>
                    </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="title-box">
                    <h2>Fee</h2>
                    <h1>{{ number_format((($sum_charge_month == 0 || $credit_revenue_month->total_credit == 0 ? 0 : $sum_charge_month - $credit_revenue_month->total_credit ?? 0)+ $wp_charge[0]['fee_month']) + ($agoda_charge[0]['fee_month'] + $ev_charge[0]['fee_month']), 2) }}</h1>
                </div>
                <div class="d-flex align-content-stretch flex-wrap fee"
                    ...
                    <a href="#" class="list-box5 list-box-color">
                        ...
                        <h3>{{ number_format($sum_charge_month == 0 || $credit_revenue_month->total_credit == 0 ? 0 : $sum_charge_month - $credit_revenue_month->total_credit ?? 0, 2) }}</h3>
                    </a>
                    <a href="#" class="list-box5 list-box-color">
                        <img src="../assets2/images/water-park.png" alt="">
                        <h2>Credit Card Water Park Fee</h2>
                        <h3>{{ number_format($wp_charge[0]['fee_month'], 2) }}</h3>
                    </a>
                    <a href="#" class="list-box5 list-box-color">
                        <img src="../assets2/images/agoda.png" alt="">
                        <h2>Agoda Fee</h2>
                        <h3>{{ number_format($agoda_charge[0]['fee_month'], 2) }}</h3>
                    </a>
                    <a href="#" class="list-box5 list-box-color">
                        <img src="../assets2/images/elexa.png" alt="">
                        <h2>Elaxa EGAT Fee</h2>
                        <h3>{{ number_format($ev_charge[0]['fee_month'], 2) }}</h3>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="d-flex align-content-stretch flex-wrap type"
                    ...
                    <a href="#" class="list-box7 list-box-color">
                        ...
                        <h3>{{ number_format($total_transfer_month, 2) }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>Credit Card Hotel <br>
                            Transfer Transaction</h2>
                        <h3>{{ $total_credit_transaction_month ?? 0 }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>Split Credit Card Hotel Revenue</h2>
                        <h3>{{ number_format($total_split_month, 2) }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>Split Credit Card Hotel Transaction</h2>
                        <h3>{{ number_format($total_split_transaction) }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>No Income Revenue</h2>
                        <h3>{{ number_format($total_not_type_revenue_month, 2) }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>Total Transaction</h2>
                        <h3>{{ number_format($total_transaction_month->total_transaction ?? 0) }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>Tranfer Transaction</h2>
                        <h3>{{ $total_transfer2_month }}</h3>
                    </a>

                    <a href="#" class="list-box7 list-box-color">
                        <h2>No incoming Type</h2>
                        <h3>{{ $total_no_type_month->total_no_type ?? 0 }}</h3>
                    </a>
                </div>
            </div>
