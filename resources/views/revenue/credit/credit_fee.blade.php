            ...
            <table id="example" class="display">
                <thead>
                    <tr>
                        ...
                        <th>ประเภทรายได้</th>
                        <th>Credit Card Manual Charge</th>
                        <th>Credit Fee</th>
                        <th>Credit Card Revenue</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $total = 0; ?>
                    @foreach ($credit_fee as $key => $item)
                    <tr style="font-weight: bold; color: black;">
                        ...
                        <td>{{ number_format($item->agoda_charge - $item->agoda_outstanding, 2) }}</td>
                        <td>{{ number_format($item->agoda_outstanding, 2) }}</td>
                    </tr>
                    <?php $total += $item->agoda_charge; ?>
                    @endforeach
                </tbody>
