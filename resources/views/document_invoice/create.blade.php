                ...
                <div class="row mt-2">
                    <div class="col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="Payment0" name="Payment" min="1" max="100" disabled oninput="validateInput(this)">
                        ...
                        <tbody id="display-selected-items">
                            <tr>
                                ...
                                <td style="text-align:left">{{$InvoiceID}} อ้างอิง Proposal เลขที่ {{$QuotationID}} ชำระจำนวน <span id="Amount" style="display: none;"></span>
                                    <span id="Amount1" style="display: none;"></span> ยอดเต็ม {{ number_format($Quotation->Nettotal, 2) }} บาท <br>กรุณาชำระมัดจำ งวดที่ 1</td>
                                <td style="text-align:right">{{ number_format($Quotation->Nettotal, 2) }}฿</td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                @php
                                    $before = 0;
                                    $before = $Quotation->Nettotal - $Quotation->AddTax;
                                @endphp
                                <td style="text-align:right">Price Before Tax :</td>
                                <td style="text-align:right">{{ number_format($before, 2) }}฿</td>
                            </tr>
                            <tr>
                                <td><br></td>
                                <td style="text-align:right">Value Added Tax :</td>
                                <td style="text-align:right">{{ number_format($Quotation->AddTax, 2) }}฿</td>
                            </tr>
                            <tr>
                                <td><br></td>
