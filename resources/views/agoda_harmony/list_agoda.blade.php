...
<div id="content-index" class="body-header border-bottom d-flex py-3">
    <div class="container-xl">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="{{ route('harmony-debit-agoda') }}" class="bt-tg-normal">Back</a>
            </div>
        </div> <!-- .row end -->
    </div>
</div>
                            ...
                            <td>
                                ...
                                <div class="dropdown center">
                                    ...
                                    <ul class="dropdown-menu btn-dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($item->status_receive_agoda == 0)
                                            <li>
                                                <a href="{{ route('harmony-debit-agoda-update-receive', [$item->id, $month, $year]) }}" class="dropdown-item">Create</a>
                                            </li>
                                        @else
                                            @php
                                            ...
                                            @if (@$item->statusLockAgoda->status_lock == 0)
                                                <li>
                                                    <a href="{{ route('harmony-debit-agoda-update-receive', [$item->id]) }}" class="dropdown-item">Edit</a>
                                                </li>
                                            @endif
                                        @endif
                                        <li>
                                            <a href="{{ route('harmony-debit-agoda-detail', [$item->id]) }}" class="dropdown-item">View</a>
                                        </li>
