                    ...
                    <div class="card p-4 mb-4">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="SpecialDiscount"  placeholder="ส่วนลดคิดเป็น %" >
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="DiscountAmount"   placeholder="ส่วนลดคิดเป็นบาท" >
