                    ...
                    <div class="card p-4 mb-4">
                                        ...
                                        <div class="col-12 col-md-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12" id="reportrange1">
                                                    <input type="text" id="datestart" class="form-control" name="IssueDate" style="text-align: left;" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-12 col-sm-12 mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" id="dateex" class="form-control" name="Expiration" style="text-align: left;"readonly disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select name="Company" id="Company" class="select2" onchange="companyContact()" required disabled>
