        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <div class=""><span class="span1">Dummy Proposal (แบบร่างข้อเสนอ)</span></div>
                </div>
                <div class="col-auto">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            @elseif ($item->status_document == 4)
                                                                @if (@Auth::user()->roleMenuEdit('Proposal',Auth::user()->id) == 1)
                                                                    <li><a class="dropdown-item py-2 rounded" href="{{ url('/Dummy/Quotation/edit/'.$item->id) }}">Edit</a></li>
                                                                    <li><a class="dropdown-item py-2 rounded" onclick="Cancel('{{$item->id}}')">Cancel</a></li>
                                                                    <li><a class="dropdown-item py-2 rounded" href="{{ url('/Dummy/Quotation/Revice/'.$item->id) }}">Revice</a></li>
                                                                @endif
                                                            @elseif ($item->status_document == 5)
                                                            @else
                                                            <li><a class="dropdown-item py-2 rounded" href="{{ url('/Dummy/Quotation/cancel/'.$item->id) }}">Revice</a></li>
                                                            @endif
                                                            <li><a class="dropdown-item py-2 rounded" href="{{ url('/Dummy/Quotation/view/quotation/LOG/'.$item->id) }}">LOG</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
