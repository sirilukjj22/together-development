...
@section('content')
        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <div class="span3">Edit Dummy Proposal</div>
                </div>
                <div class="col-auto">
                </div>
            </div> <!-- .row end -->
    ...
    <form id="myForm" action="{{url('/Dummy/Proposal/edit/company/quotation/update/'.$Quotation->id)}}" method="POST">
        @csrf
                        ...
                        <div class="card p-4 mb-4">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <span for="">จำนวน</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Day" id="Day" placeholder="จำนวนวัน"value="{{$Quotation->day}}" readonly>
                                        <span class="input-group-text">Day</span>
                                        <input type="text" class="form-control" name="Night" id="Night" placeholder="จำนวนคืน"value="{{$Quotation->night}}"readonly>
