    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                ...
                <h1 class="h4 mt-1">Create Dummy Proposal (เพิ่มแบบร่างข้อเสนอ)</h1>
            </div>
        </div>
    </div>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <span class="titleQuotation">{{$DummyNo}}</span>
                                    <input type="hidden" id="Quotation_ID" name="DummyNo" value="{{$DummyNo}}">
...
<script>
    ...
    function companyContact() {
        ...
        jQuery.ajax({
            type: "GET",
            url: "{!! url('/Dummy/Quotation/create/company/" + companyID + "') !!}",
            datatype: "JSON",
            async: false,
