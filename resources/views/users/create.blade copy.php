    ...
    <div class="container-fluid border rounded-3 p-5 mt-3 bg-white" style="width: 98%;">
        ...
        <form action="{{ route('register.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-start mt-4">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_company" id="menu_company" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_guest" id="menu_guest" value="1">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_agoda" id="menu_agoda" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_elexa" id="menu_elexa" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_request_repair" id="menu_request_repair" value="1">
                ...
                <!-- <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_product_item" id="menu_product_item" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_quantity" id="menu_quantity" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_unit" id="menu_unit" value="1">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_prefix" id="menu_prefix" value="1">
                ...
                <!-- <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_bank_company" id="menu_bank_company" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_company_type" id="menu_company_type" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_company_market" id="menu_company_market" value="1">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_company_event" id="menu_company_event" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_menu" name="menu_booking" id="menu_booking" value="1">
            ...
            <div class="row justify-center mt-4">
                ...
                <div class="col-lg-2 col-md-8 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="select_revenue_all" id="select_revenue_all" value="0">
            ...
            <div class="row justify-content-start ">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="front_desk" id="front_desk" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="guest_deposit" id="guest_deposit" value="1">
                        <label class="form-check-label" for="guest_deposit">Guest Deposit Revenue</label>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="all_outlet" id="all_outlet" value="1">
                        <label class="form-check-label" for="all_outlet">All Outlet Revenue</label>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="agoda" id="agoda" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="credit_card_hotel" id="credit_card_hotel" value="1">
                        <label class="form-check-label" for="credit_card_hotel">Credit Card Hotel Revenue</label>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="elexa" id="elexa" value="1">
                        <label class="form-check-label" for="elexa">Elexa EGAT Revenue</label>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="water_park" id="water_park" value="1">
                        <label class="form-check-label" for="water_park">Water Park Revenue</label>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="credit_water_park" id="credit_water_park" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="no_category" id="no_category" value="1">
                        <label class="form-check-label" for="no_category">No Category</label>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="transfer" id="transfer" value="1">
                        <label class="form-check-label" for="transfer">Transfer</label>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="time" id="time" value="1">
                        <label class="form-check-label" for="time">Update Time</label>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="split" id="split" value="1">
                ...
                <div class="col-lg-2 col-md-4 col-sm-12">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input select_revenue" name="edit" id="edit" value="1">
