            ...
            <div class="col-sm-12 col-12">
                <form id="myForm" action="{{url('/Company/editTax/update/'.$CompanyID.'/'.$viewTax->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card p-4 mb-4">
                        ...
                        <div class="row" id="Com" style="display: block">
                            <div class="row">
                                <div class="col-sm-6 col-6">
                                    ...
                                    <select name="Company_type" id="Company_type_tax" class="form-select" >
                                        <option value=""></option>
                        ...
                        <input type="hidden" id="Company_id" class="form-control" name="Company_ID" maxlength="70"  value="{{$viewTax->Company_ID}}">
                        <div class="row mt-2" id="Title" style="display: none;">
                            <div class="row">
                                <div class="col-sm-6 col-6" >
                                    <span for="prefix">คำนำหน้า / Title</span>
                                    <select name="Company_type" id="PrefaceSelectCom" class="form-select" >
                                            <option value=""></option>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-4 col-4" id="cityInputA" style="display:none;">
                                ...
                                <input type="text" id="cityA" class="form-control" name="City" value="{{$Other_City}}" >
                            </div>
                            <div class="col-sm-4 col-4" id="citythaiA" style="display:block;">
                                <span for="City">City</span>
                                <select name="City" id="provinceAgent" class="form-select" onchange="provinceA()" style="width: 100%;" >
                                    <option value=""></option>
                            ...
                            <div class="col-sm-4 col-4">
                                ...
                                <select name="Amphures" id="amphuresA" class="form-select" onchange="amphuresAgent()" >
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-4 col-4">
                                ...
                                <select name="Tambon" id ="TambonA" class="form-select" onchange="TambonAgent()" style="width: 100%;">
                            ...
                            <div class="col-sm-4 col-4">
                                ...
                                <select name="Zip_Code" id ="zip_codeA" class="form-select"  style="width: 100%;">
