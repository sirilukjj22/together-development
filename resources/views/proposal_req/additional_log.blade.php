        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col sms-header">
                    <small class="text-muted">Welcome to Proposal Request Log.</small>
                    <div class=""><span class="span1">Proposal Request Log</span></div>
                </div>
            </div> <!-- .row end -->
        </div>
    </div>
                            ...
                            <div style="min-height: 70vh;" class="mt-2">
                                <caption class="caption-top">
                                    <div class="flex-end-g2">
                                        ...
                                        <select class="entriespage-button" id="search-per-page-proposal-Log" onchange="getPageLog(1, this.value, 'proposal-Log')"> <!-- ชือนำหน้าตาราง, ชื่อ Route -->
                                ...
                                <caption class="caption-bottom">
                                    <div class="md-flex-bt-i-c">
                                        <p class="py2" id="proposal-Log-showingEntries">{{ showingEntriesTableLog($log, 'proposal-Log') }}</p>
                                            <div id="proposal-Log-paginate">
                                                {!! paginateTableLog($log, 'proposal-Log') !!} <!-- ข้อมูล, ชื่อตาราง -->
                                            </div>
                                    </div>
                                </caption>
                            </div>
        ...
        $(document).on('keyup', '.search-data-proposal-Log', function () {
            ...
            console.log(guest_profile);
                ...
                var table = $('#'+table_name).dataTable({
                    ...
                    info: false,
                    ajax: {
                    url: '/Additional-LogDoc-request-search-table',
                    type: 'POST',
                    dataType: "json",
                    cache: false,
                    data: {
